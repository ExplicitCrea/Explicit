  ...
  return (
    <StyledVzion>
      ...
      <div className="quaternary-wrapper">
        <p>
          {t('vzion.quaternary-wrapper.paragraph')}
        </p>
        <Grid />
      </div>
    </StyledVzion>
